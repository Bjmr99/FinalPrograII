    ...
    public Estudiantes(){
        ...
        grabarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                new EstudiantesDB().GrabarEstuidante(txtNombre.getText(), txtApellido.getText(), txtEmail.getText());
                LlenarLista();
            }
        });
        ...
        eliminarButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new EstudiantesDB().DeleteEstudiante(id);
                LlenarLista();
            }
        });
        btnUpdate.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new EstudiantesDB().UpdateEstudiante(id ,txtNombre.getText(), txtApellido.getText(), txtEmail.getText());
                LlenarLista();
            }
        });
