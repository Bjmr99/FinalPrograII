...
public class Cursos extends JFrame{
    ...
    public Cursos(){
        ...
        btnGrabar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new CursosDB().GrabarCurso(txtNombreCurso.getText(), txtProfesor.getText());
                LlenarLista();
            }
        });
        btnUpdate.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new CursosDB().UpdateCurso(id,txtNombreCurso.getText(), txtProfesor.getText());
                LlenarLista();
            }
        });
